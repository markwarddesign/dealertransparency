  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden">
        {/* Animated background */}
        <div className="absolute inset-0 bg-gradient-to-b from-black via-navy to-black"></div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <h1 className="text-7xl lg:text-9xl font-black mb-8 bg-clip-text text-transparent bg-gradient-to-r from-white via-electric-blue to-white">
            RPM
          </h1>
          <p className="text-3xl lg:text-4xl font-light mb-6 text-gray-300">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <a
              href="#contact"
              className="px-10 py-5 bg-transparent text-white text-lg font-semibold rounded-xl border-2 border-white/30 hover:border-electric-blue hover:bg-electric-blue/10 transition-all duration-300 backdrop-blur-sm"
            >
              Get Started
            </a>
          </div>
      ...
      <section id="solutions" className="relative py-16 px-6 bg-black">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {/* RADAR Card */}
            <div className="group relative bg-gradient-to-br from-gray-900 to-black rounded-3xl p-8 border border-gray-800 hover:border-electric-blue/50 transition-all duration-500 hover:scale-105">
      ...
      <section className="relative py-32 px-6 bg-black border-t border-gray-900">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-6xl font-bold mb-6">Real Results</h2>
            <p className="text-xl text-gray-400">Measurable impact from actual dealer groups</p>
          </div>
      ...
      {/* CTA Section */}
      <section id="contact" className="relative py-32 px-6 bg-gradient-to-b from-gray-900 to-black">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-5xl lg:text-6xl font-bold mb-8">Ready to Transform Your Dealership?</h2>
